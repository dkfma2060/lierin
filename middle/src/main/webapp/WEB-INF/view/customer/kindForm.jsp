					...
					<div class = "cunit_prod">
						<c:choose>
								<c:when test="${products[i].quantity == 0}">
									<img src="/middle/img/Simage/${imagebyProduct[i]}" style="width:180px; height:180px;">
								</c:when>
								<c:otherwise>
									<a href="/middle/customer/pseq=${products[i].pseq}">
										<img src="/middle/img/Simage/${imagebyProduct[i]}" style="width:180px; height:180px;">
									</a>							
								</c:otherwise>
							</c:choose>
					...
					<div class = "cunit_info">
						<div class = "title">
							<c:choose>
								...
								<c:otherwise>
									<a href="/middle/customer/pseq=${products[i].pseq}">${products[i].name}</a>								
								</c:otherwise>
							</c:choose>
						</div>
						<div>
