...
<script type="text/javascript">
   function insertLike(pseq){
      form.action = "/middle/customer/like="+pseq;
      form.submit();
   }
   
   function disLike(pseq){
      form.action= "/middle/customer/dislike="+pseq;
      form.submit();
   }
</script>
</head>
	...
	<form action="" name='form'>
		...
		<div class="swiper-container mySwiper">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="/middle/img/add1.PNG" />
				</div>
				<div class="swiper-slide">
					<img src="/middle/img/welcomecustomer.png" />
					<!-- 광고 이미지 -->
				</div>
			</div>
			<div class="swiper-button-next" style="z-index: 5;"></div>
			<div class="swiper-button-prev" style="z-index: 5;"></div>
		...
		<div style="width: 1920px; align: center;">
								...
								<div class="cunit_prod">
									<c:choose>
										<c:when test="${product.quantity == 0}">
											<img src="/middle/img/Simage/${product.url}"
												style="width: 250px; height: 250px;">
										</c:when>
										<c:otherwise>
											<a href="/middle/customer/pseq=${product.pseq}"> <img
												src="/middle/img/Simage/${product.url}"
												style="width: 250px; height: 250px;">
											</a>
										</c:otherwise>
									</c:choose>
										...
										<Strong> <c:choose>
												...
												<c:otherwise>
													<a style="padding-left: 30px; font-size: 20px;"
														href="/middle/customer/pseq=${product.pseq}">${product.name}</a>
												</c:otherwise>
											</c:choose>
										</Strong>
									</div>
			...
			<div class="recommend">
				...
				<div class="recommend_list_area">
					...
					<div class="ad" style="float: left;">
						<img
							style="width: 100%; margin-top: 20px; margin-left: 10px; margin-right: 250px; padding-left: 40px"
							src="/middle/img/mainadd2.jpg">
					</div>
					<!-- 추천 상품 부분 -->
					<div class="recommend_detail">
						<ul class="cunit_thmb_lst"
							style="margin: 0px; padding: 10px; text-align: center;">
							<c:forEach var="Rproduct" items="${Rproducts}">
								<li class="cunit_t232"
									style="padding: 10px 20px 40px 10px; width: 300px;">
									<div class="cunit_prod">
										<c:choose>
											<c:when test="${Rproduct.quantity == 0}">
												<img src="/middle/img/Simage/${Rproduct.url}"
													style="width: 250px; height: 250px;">
											</c:when>
											<c:otherwise>
												<a style="font-size: 12px;"
													href="/WUE/customer/pseq=${Rproduct.pseq}"> <img
													src="/middle/img/Simage/${Rproduct.url}"
													style="width: 250px; height: 250px;">
												</a>
											</c:otherwise>
										</c:choose>
									...
									<div class="cunit_info">
										<div class="title">
											<Strong> <c:choose>
													...
													<c:otherwise>
														<a style="font-size: 12px;"
															href="/middle/customer/pseq=${Rproduct.pseq}">${Rproduct.name}</a>
													</c:otherwise>
												</c:choose>
											</Strong>
										</div>
			...
			<div class="main_page_url">
				<a href="/middle/index"> What You Eat </a>
