...
<body>
	...
	<main class="to_do_list">
		<div style="margin-top: 200px; margin-left: 220px;">
			<form action="reviewAdd" method="post" onsubmit="return nullCheck();"
				...
				<table class="register" border=1 align=center cellspacing=1
					...
					<tr>
						<td colspan=2 height=2><textarea rows="" cols="" id="detail"
								name="detail" size=200 maxlength=250
								style="width: 600px; height: 221px;"></textarea></td>
					</tr>


					<tr>
						<td colspan=2 align=center height=30><input type="hidden"
							value="${order.odseq}" name="odseq" id="odseq"> <input
							type=submit value="후기 등록"> <input type=reset value=취소
