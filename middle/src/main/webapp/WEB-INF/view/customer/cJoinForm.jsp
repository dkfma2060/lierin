...
<script type="text/javascript">
	function idCheck() {
		...
		window.open('Idcheck?email=' + frmmember.email.value + '&email2='
				+ frmmember.email2.value, 'popup', 'width=500,height=300');
	}
...
<body>
	...
	<main>
		<form name="frmmember" action="Join" onsubmit="return nullCheck();"
			method="post">
			<!-- true가 되어야 전송이 가능한 것, 투르가 아니면 전송을 못함 -->
			<h1 style="text-align: center; margin-top: 80px; color: #12467a;">회원
				가입</h1>
			<fieldset
				style="margin: auto; width: 500px; height: 180px; padding: 30px">
				<table border="0" align=center cellspacing=1 bordercolor=white
					...
					<tr>
						...
						<td><input type=text id='name' name='name'
							value='${ param.mname }' size=20 maxlength=20
							pattern="^[가-힣]*{2,10}">&nbsp;(한글 2자~10자로 입력해주세요)</td>
					</tr>
					<tr>
						<td colspan=1 align=center style="background-color: #FEDD89;">E-mail주소
						</td>
						<td><input type=text id='email' name=email
							value='${ param.email }' size=12 maxlength=12 onclick="idCheck()"
							readonly>&nbsp;@&nbsp; <select id='email2' name=email2>
								<option value="이메일 선택">이메일 선택</option>
								<option value="naver.com">naver.com</option>
								<option value="gmail.com">gmail.com</option>
								<option value="daum.net">daum.net</option>
								<option value="nate.com">nate.com</option>
						</select> <img style="width: 3%; vertical-align: middle;" id='dc'
							src="/middle/image/search.png" onclick="idCheck()"></td>
					</tr>

					<tr>
						<td align=center style="background-color: #FEDD89;">비밀번호</td>
						<td><input type=password id='pw' name=pw
							value='${ param.pwd }' size=12 maxlength=20
							pattern="[a-zA-Z0-9]{6,20}">&nbsp;(영어 및 숫자만 허용,6글자~20글자)</td>
					</tr>
					<tr>
						<td align=center style="background-color: #FEDD89;">비밀번호 확인</td>
						<td><input type=password id='pw2' value='${ param.pwd }'
							name=pw2 size=12 maxlength=20 pattern="[a-zA-Z0-9]{6,20}">&nbsp;(영어
							및 숫자만 허용,6글자~20글자)</td>
					</tr>
					...
					<tr>
						...
						</select>- <input type=text id='phone2' name=phone2 size=4 maxlength=4>&nbsp;-&nbsp;
							<input type=text id='phone3' name=phone3 size=4 maxlength=4></td>
					</tr>
					<tr>
						<td colspan=2 bgcolor=white align=center height=30></td>
					</tr>
					<tr>
						<td colspan=2 bgcolor=white align=center height=30>
							<!-- <input type=submit value=가입하기 > --> <input type="submit"
							class="join-btn" value="가입하기" size="100"> <input
