			...
			<article
				...
				<div
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<span style="background-color: pink;"><a
						href="/middle/worker/kind=1">Fruit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="/middle/worker/kind=2">Vegetable</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="/middle/worker/kind=3">Rice / Mixed_grains</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="/middle/worker/kind=4">Nuts</a></span>
				</div>
				<p>
				<table
					...
					<c:forEach var="i" begin="0" end="${size-1}">
						<tr align="center">
							<td style="border-bottom: 1px solid #444444; padding: 10px;">
								<img src="/middle/img/Simage/${imagebyProduct[i]}"
