...
<body>
	...
	<form name="frmmember" action="SUpdate" method="post"
		...
		<article style="margin-top: 100px;">
			...
			<fieldset style="width: 600px; position: relative; left: 30%;">
				<table border="0" align=center cellspacing=1 bordercolor=white
					...
					<tr>
						<td style="width: 130px;" colspan=1 bgcolor=#99ccff align=center>E-mail주소
						</td>
						<td><input type=text id='email' name=email size=12
							maxlength=12 readonly="readonly" value="${user.email}"
					...
					<tr>
						...
						<td><input type=text id='name' name='name' size=12
							maxlength=20 value="${user.name}" pattern="^[가-힣]*{2,10}">&nbsp;(한글
							2자~10자로 입력해주세요)</td>
					</tr>
					...
					<tr>
						...
						<td><input type=text name=zip_num size=3 maxlength=3
							id="post" value="${user.zip_num}" style="width: 100px;">
							<img style="width: 3%; vertical-align: middle;" id='dc'
							src="/middle/img/search.png" onclick="sample4_execDaumPostcode()"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan=2 bgcolor=white align=center height=30><input
							...
							onclick='location.href= "SMain"' /> <input type="button"
