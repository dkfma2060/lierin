	...
	<div class="section">
		...
		<div class="SellProduct">
			<c:forEach var="i" begin="0" end="${Sellimage.size()-1}">
				<div class="imagelist">
					<a href="ProuctUpdateForm?pseq=${Sellproduct[i].pseq}"> <label
						style="font-size: 18px; font-family: Inter; font-weight: Regular; margin-left: 130px;">수정</label>
					</a> <a href="ProductListDelte?pseq=${Sellproduct[i].pseq}"
						onclick="return checkDelte();"> <label
						style="font-size: 18px; font-family: Inter; font-weight: Regular; margin-left: 10px;">삭제</label>
					</a>

					<div class="productImage">
						<a> <img style="width: 100%; height: 100%;"
							src="/middle/img/Simage/${Sellimage[i]}">
						</a>
					</div>
					<div class="item">
						<table border="1" style="height: 300px; width: 220px;">
							<tr>
								...
								<td
									style="height: 20%; margin: 0%; word-break: keep-all; word-wrap: break-word">
			...
			<c:otherwise>
				<div class="SellProduct">
					<c:forEach var="i" begin="0" end="${Sellimage2.size()-1}">
						<div class="imagelist">
							<a href="ProuctUpdateForm?pseq=${readyproduct[i].pseq}"> <label
								style="font-size: 18px; font-family: Inter; font-weight: Regular; margin-left: 130px;">수정</label>
							</a> <a href="ProductListDelte?pseq=${readyproduct[i].pseq}"
								onclick="return checkDelte();"> <label
								style="font-size: 18px; font-family: Inter; font-weight: Regular; margin-left: 10px;">삭제</label>
							</a>
							<div class="productImage">
