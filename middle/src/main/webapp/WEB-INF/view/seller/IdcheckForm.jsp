...
<script type="text/javascript">
	...
	function idCheck() {
		...
		if (email.includes("@") == true) {
			str = email.split(/[@]/);
			if (str[1] != 'naver.com' && str[1] != 'daum.net'
					&& str[1] != 'nate.com' && str[1] != 'gmail.com')
	...
	<div id="wrap">
		...
		<div id="chk">
			<form action="Idcheck" method="get" name="idcheck"
				...
				<input type="text" name="email" value="${param.email}"> <input
					type="submit" value="다시 중복확인"> <input type="hidden"
					name="email2" value="${param.email2}">
			</form>
			<div id="msg">
				<br>
				<div>
				...
				<input id="cancelBtn" type="button" value="취소"> <input
					id="useBtn" type="button" value="사용하기" onclick="useEmail()">
			</div>
		</div>
	</div>
</body>
