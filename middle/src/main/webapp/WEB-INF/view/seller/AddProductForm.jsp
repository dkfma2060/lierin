...
<body>
	...
	<div class="container">
		...
		<form name="newProduct" action="ProductAdd" class="form-horizontal"
			...
			<div class="form-group row">
				...
				<div class="com-sm-3">
					<input type="text" id="unitPrice" name="sale_price"
						class="form-control">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="com-sm-3">
					<input type="text" id="unitsInStock" name="quantity"
						class="form-control">
				</div>
			</div>
			...
			<div class="form-group row" id="image_previews">
				...
				<div id="att_zone">
					<input type="file" class="fileall" id="btnAtt" name="productImage"
						multiple="multiple">
