...
<body>
	...
	<!-- <form name=frm1> -->
	<form name="frmmember" action="SJoin" onsubmit="return nullCheck();"
		method="post">
				...
				<table border="0" align=center cellspacing=1 bordercolor=white
					...
					<tr>
						...
						<td><input type=text id='email' name=email size=12
							...
							src="/WUE/img/search.png" onclick="idCheck()"></td>
					</tr>
					...
					<tr>
						...
						<td><select id='phone' name=phone>
							...
							pattern="[0-9]{3,4}">&nbsp;-&nbsp; <input type=text
							id='phone3' name=phone3 size=4 maxlength=4 pattern="[0-9]{4}"></td>
					</tr>
					<tr>
